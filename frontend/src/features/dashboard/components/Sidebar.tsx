...
// Menu items have no reactive deps — defined outside to avoid recreation on every render
const MENU_ITEMS = [
    { path: APP_ROUTES.DASHBOARD.ROOT, icon: <DashboardIcon sx={{ fontSize: 20 }} />, label: 'Overview', exact: true },
    { path: `${APP_ROUTES.DASHBOARD.ROOT}/${APP_ROUTES.DASHBOARD.LIVE_TRACKING}`, icon: <GpsFixedIcon sx={{ fontSize: 20 }} />, label: 'Live Tracking', exact: false },
    { path: `${APP_ROUTES.DASHBOARD.ROOT}/${APP_ROUTES.DASHBOARD.TRIPS}`, icon: <HistoryIcon sx={{ fontSize: 20 }} />, label: 'History', exact: false },
    { path: `${APP_ROUTES.DASHBOARD.ROOT}/${APP_ROUTES.DASHBOARD.DRIVERS}`, icon: <BarChartIcon sx={{ fontSize: 20 }} />, label: 'Analysis', exact: false },
    { path: `${APP_ROUTES.DASHBOARD.ROOT}/${APP_ROUTES.DASHBOARD.UPLOAD}`, icon: <UploadFileIcon sx={{ fontSize: 20 }} />, label: 'Upload', exact: false },
] as const;
